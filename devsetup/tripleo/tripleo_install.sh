...
for cdfile in ${cdfiles[@]}; do
    ...
    if [ "$EDPM_COMPUTE_CEPH_ENABLED" == "true"  ] ; then
        ...
        sed -i "s/::Compute::/::ComputeHCI::/" "$cdfile"
        ...
        sed -i "s#$stg_line#$stg_line\r  $stg_mgmt_line\r#" "$cdfile"
