...
${1}: export AETOS_PASSWORD=${AETOS_PASSWORD}
...
openstack_versions_master:
	...
	PATCH_FILE=$(OV_MASTER_PATCHFILE) NAMESPACE=$(NAMESPACE) bash scripts/fetch-image-digests.sh $(OUT)/image-mappings.yaml
