...
DESIGNATEAPI_CR   ?= ${OPERATOR_BASE_DIR}/designate-operator/${DESIGNATE}
DESIGATEAPI_IMG   ?= ${SERVICE_REGISTRY}/${SERVICE_ORG}/openstack-designate-api:current-tripleo
...
.PHONY: cleanup
cleanup: horizon_cleanup nova_cleanup octavia_cleanup designate_cleanup neutron_cleanup ovn_cleanup ironic_cleanup cinder_cleanup glance_cleanup placement_cleanup keystone_cleanup mariadb_cleanup telemetry_cleanup ## Delete all operators

.PHONY: deploy_cleanup
deploy_cleanup: horizon_deploy_cleanup nova_deploy_cleanup octavia_deploy_cleanup designate_deploy_cleanup neutron_deploy_cleanup ovn_deploy_cleanup ironic_deploy_cleanup cinder_deploy_cleanup glance_deploy_cleanup placement_deploy_cleanup keystone_deploy_cleanup mariadb_deploy_cleanup telemetry_deploy_cleanup ## Delete all OpenStack service objects
...
designate_prep: export IMAGE=${DESIGNATE}
...
designate_deploy_prep: export IMAGE=unused
