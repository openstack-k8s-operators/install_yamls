...
if [ "${FAKE_UPDATE}" != "false" ]; then
    ...
    ${UPDATE_ARTIFACT_DIR}/update_step.sh Applying Fake Update CR
...
${UPDATE_ARTIFACT_DIR}/update_step.sh Patching the Openstack Version
...
${UPDATE_ARTIFACT_DIR}/update_step.sh MinorUpdateOVNControlplane Completed
...
${UPDATE_ARTIFACT_DIR}/update_step.sh Applying the OVN CRD
...
${UPDATE_ARTIFACT_DIR}/update_step.sh MinorUpdateOVNDataplane Completed
...
${UPDATE_ARTIFACT_DIR}/update_step.sh MinorUpdateControlplane Completed
...
${UPDATE_ARTIFACT_DIR}/update_step.sh Applying the UPDATE CRD
...
${UPDATE_ARTIFACT_DIR}/update_step.sh MinorUpdateDataplane Completed
